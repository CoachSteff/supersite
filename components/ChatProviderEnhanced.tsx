...
export function ChatProviderEnhanced({ children }: { children: ReactNode }) {
...
export function useChatEnhanced() {
  ...
  if (context === undefined) {
    throw new Error('useChatEnhanced must be used within a ChatProviderEnhanced');
  }
  return context;
}

// Re-export for backward compatibility
export { ChatProviderEnhanced as ChatProvider, useChatEnhanced as useChat };
